  ...
  <div class="app-container">
    ...
    <div class="page-header">
      <div class="header-title">
        <span class="title">事件优先级</span>
        <el-tooltip content="定义事件处理的优先级顺序和重要程度" placement="right">
    ...
    <el-card shadow="never" class="table-card">
      ...
      >
        <el-table-column label="优先级编码" prop="value" width="120" />
        <el-table-column label="优先级名称" prop="label" width="120" />
    ...
    <!-- 编辑对话框 -->
    <el-dialog
      :title="dialogType === 'create' ? '新增优先级' : '编辑优先级'"
    ...
    >
      ...
      >
        ...
        <div class="form-section">
          ...
          <el-form-item label="优先级编码" prop="value">
            <el-input 
              v-model="temp.value" 
          ...
          <el-form-item label="优先级名称" prop="label">
            <el-input 
              v-model="temp.label" 
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        value: [{ required: true, message: '请输入优先级编码', trigger: 'blur' }],
        label: [{ required: true, message: '请输入优先级名称', trigger: 'blur' }],
